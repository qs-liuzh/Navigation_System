...
class MainWindow(QMainWindow):
    ...
    def generate_path(self):
        ...
        self.plot_graph.plot(points_np[path, 0], points_np[path, 1], pen={'color': 'green', 'width': 4})
    ...
    def generate_path_2(self):
        ...
        self.plot_graph.plot(points_np[path, 0], points_np[path, 1], pen={'color': 'yellow', 'width': 4})
